...
function handleTransaction(txEvent) {
    return __awaiter(this, void 0, void 0, function () {
        var findings, transferCompEvent, amountCompDripped;
        return __generator(this, function (_a) {
            findings = [];
            // if not calling compound reservoir, return
            if (txEvent.to !== constants_1.COMPOUND_RESERVOIR_ADDRESS)
                return [2 /*return*/, findings
                    // if not calling drip() method, return
                ];
            // if not calling drip() method, return
            if (txEvent.transaction.data !== constants_1.DRIP_METHOD_ID)
                return [2 /*return*/, findings
            ...
            amountCompDripped = new bignumber_js_1.default(transferCompEvent.data);
